...
const Socials = () => {
  return (
    <div className='home__social'>
        <a href="https://github.com/MokomCollinsAwah" className="home__social-icon" target='_blank' rel='noreferrer'>
            <i className="uil uil-github"></i>
        </a>
        <a href="https://www.linkedin.com/in/mokomcollinsawah" className="home__social-icon" target='_blank' rel='noreferrer'>
